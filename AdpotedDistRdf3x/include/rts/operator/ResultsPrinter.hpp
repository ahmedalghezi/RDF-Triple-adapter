...
class ResultsPrinter : public Operator
{
   ...
   Operator* OpgetResultPrinter();
   // ---------------- Ahmed -------------------------
   Operator* getResultPrinter(){
   	return this;
   }
    bool isFinished(){
    ...
    //Ahmed vector:
    vector<vector<unsigned> *> pendingBorderRegsOther;
    vector<vector<unsigned> *> pendingBorderRegsLeft; // the left side is found waiting for the right
    vector<vector<unsigned> *> pendingCompressedResults; // for the cimpressed results
};
//---------------------------------------------------------------------------
#endif
