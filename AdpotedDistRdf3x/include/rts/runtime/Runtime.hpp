...
class Runtime
{
   ...
   Runtime(Database& db , chat_client *chatClient,DifferentialIndex* diff=0,TemporaryDictionary* temporaryDictionary=0);
   /// Destructor
   ~Runtime();
   ...
   //Ahmed
   chat_client* getChatClient(){
       return mChatClient;
   }
   
   void getStringHashValue(unsigned);
